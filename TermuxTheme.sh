#!/bin/bash
# Coded by HαρρყDҽʋιL
# Created since on 10/02/2021 made in Nigeria by HαρρყDҽʋιL.
...
cd
mv /data/data/com.termux/files/home/Simple_Theme/code/bash.bashrc //data/data/com.termux/files/usr/etc/bash.bashrc
sleep 8.0
...
echo "Then you type exit 3x"|lolcat
